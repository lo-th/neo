...
NEO.CC("NEO.inner","width:100%; top:40px; height:auto; overflow:hidden; background:none;");NEO.CC("NEO.base","position:relative; transition:height, 0.1s ease-out; height:80px; overflow:hidden;");NEO.CC("NEO.track","position:absolute; left:0; top:20px; width:100px; height:60px; overflow:hidden; pointer-events:auto; cursor:pointer; background:none; ");NEO.CC("NEO.trackTop","position:absolute; left:0; top:20px; width:100%; height:60px; overflow:hidden; pointer-events:none; background:none; ");NEO.CC("NEO.text",
NEO.txt1);NEO.DEF=!0},bgcolor:function(a,b){var c=48,d=48,e=48;b=b||0.66;if(a)switch(a){case "r":case "R":case "S":c=160;e=68;break;case "g":case "G":case "E":d=120;e=68;break;case "b":case "B":case "T":e=120;d=68;break;case "no":case "NO":b=0}c="rgba("+c+","+d+","+e+","+b+")";0==b&&(c="none");return c},setSVG:function(a,b,c,d){a.childNodes[d||0].setAttributeNS(null,b,c)},setDOM:function(a,b,c){a.style[b]=c+"px"},clearDOM:function(a){for(;a.children.length;)a.removeChild(a.lastChild)},DOM:function(a,
...
NEO.Proto.prototype={constructor:NEO.Proto,init:function(){this.c[0].style.background=NEO.bgcolor(this.color);for(var a=0,b=this.c.length;a!==b;a++)0==a?null!==this.target?this.target.appendChild(this.c[0]):NEO.main.inner.appendChild(this.c[0]):this.c[0].appendChild(this.c[a]);this.c[5].onmouseup=function(a){this.onUp(a)}.bind(this);this.c[5].onmousedown=function(a){this.onDown(a)}.bind(this);this.c[5].onmousemove=function(a){this.onMove(a)}.bind(this);this.c[1].textContent=this.name;this.c[5].name=
this.type;this.setSize();this.keys.length&&this.addKeys()},rename:function(){this.autoName&&(this.name=this.id+"-"+this.type,this.c[1].textContent=this.name)},update:function(a){},open:function(){this.show=!0;this.setSvg(3,"d","M 12 6 L 8 10 4 6");this.h=80;this.c[2].style.display="block";this.applyHeight()},close:function(){this.show=!1;this.setSvg(3,"d","M 6 4 L 10 8 6 12");this.h=20;this.c[2].style.display="none";this.applyHeight()},applyHeight:function(){this.c[0].style.height=this.h+"px";NEO.main&&
...
this.items[a].clear();this.items.splice(a,1);this.sort()},sort:function(){var a,b=0,c=this.items.length;this.items.sort(function(a,b){return a.id-b.id});if(this.names)for(a=0;a!==c;a++)this.names[a]=this.items[a].name,this.items[a].setPy(b),2>b?b++:b=0;if(this.ends)for(a=0;a!==c;a++)this.ends[a]=this.items[a].end;if(this.colors)for(a=0;a!==c;a++)this.colors[a]=this.items[a].color;this.keys=[];for(a=this.items.length;a--;)this.keys.unshift(1*this.items[a].id)},onDown:function(a){var b=a.target.name||
"none";this.currentType=b;if("input"!=b&&"colorselect"!=b){var c=NEO.main.getFrameClick(a.clientX);this.mbutton=a.which;if("switch"==b||"itemSwitch"==b)for(a=this.items.length;a--;)b=this.items[a],c>=b.id&&c<=b.end&&(c==b.id&&(this.drag=!0,this.current=b,this.dragEnd=!1),c==b.end&&(this.drag=!0,this.current=b,this.dragEnd=!0));else-1<this.keys.indexOf(c)?(1==this.mbutton&&(this.drag=!0,this.currentIndex=this.keys.indexOf(c),this.current=this.items[this.keys.indexOf(c)]),3==this.mbutton&&(this.remove(c),
"color"==this.currentType&&this.upDegrad())):1==this.mbutton&&(this.add(c),this.sort(),"color"==this.currentType&&this.upDegrad())}},onOver:function(a){},onUp:function(a){this.drag&&(this.c[5].style.cursor="pointer",this.dragEnd=this.drag=!1,this.sort(),"color"==this.currentType&&this.upDegrad());this.currentType="none"},onMove:function(a){"none"!=this.currentType&&(a=NEO.main.getFrameClick(a.clientX),this.drag&&(this.c[5].style.cursor="e-resize",this.current.move(a,this.dragEnd),"color"==this.currentType&&
