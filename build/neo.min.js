...
new NEO.KeyBang(a);break;case "switch":b=new NEO.KeySwitch(a,this.ends[this.keys.indexOf(a)]);break;case "flag":b=new NEO.KeyFlag(a,this.names[this.keys.indexOf(a)]);break;case "color":b=new NEO.KeyColor(a,this.colors[this.keys.indexOf(a)]||this.findColor(a),this)}this.c[5].appendChild(b.content);this.items.push(b)},remove:function(a){a=this.keys.indexOf(a);this.c[5].removeChild(this.items[a].content);this.items[a].clear();this.items.splice(a,1);this.sort()},sort:function(){var a,b=0;this.items.sort(function(a,
